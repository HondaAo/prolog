...
import (
	...
	"github.com/HondaAo/proglog/internal/auth"
	"github.com/HondaAo/proglog/internal/config"
	"github.com/HondaAo/proglog/internal/log"
)

var debug = flag.Bool("debug", false, "Enable observablity for debugging")
